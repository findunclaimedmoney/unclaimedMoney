...
export default function SearchPage() {
  usePageSEO({
    title: "Search Your Name — $19.90 | MissingCash", 
    description: "Pay $19.90 and Mia searches every major Australian unclaimed money register for your name. Results emailed within minutes — guaranteed.",
  });
        ...
        <div className="max-w-md w-full">
          ...
          <div className="rounded-2xl border border-border bg-card p-6">
            ...
            <form onSubmit={submit} className="space-y-3">
              ...
              >
                {loading ? "Setting up payment…" : "Search My Name — $19.90"}
              </button>
            </form>
